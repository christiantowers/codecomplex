...
$config['APP_NAME'] = 'ACMECMS';
$config['TEMPLATE'] = 'vertigo';
$config['APP_TITLE'] = 'ACME CMS - Gerenciador de Conteúdos';
...
$config['EMAIL_GLOBAL_NAME_FROM'] = "";
$config['EMAIL_GLOBAL_ADDRESS_FROM'] = "";
