...
class Error  {
	...
	* Exibe uma mensagem de exceção, sem página master ou algo do tipo. Ideal para modais.
	* @param string message
	* @return void
	*/
    public function show_exception_message($message = '')
    {
		$this->CI =& get_instance();
		
		// Pagina com mensagem
		echo $this->CI->template->load_page('_errors/exception_message', array('message' => $message), true, false);
		exit;
    }
	...
	*/
	...
	{
		$this->CI =& get_instance();
		$this->CI->load->model('acme/libraries/error_model');
