...
/**
*
* Classe cms_access_Model (Arquivo gerado com construtor de módulos)
* 
* Módule cms_access: Acesso ao Gerenciador, tela de login e afins.
*
* @since		31/07/2013
* @location		models.cms_access_model
*
*/
class cms_access_Model extends Base_Module_Model {
	...
	* chamada $this->cms_access_Model->example(), este método será disparado.
	* @return void
	*/
