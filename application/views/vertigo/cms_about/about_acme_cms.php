...
<body>
	<div id="modal_content">
		<img src="<?php echo URL_IMG ?>/logo.png" style="width:200px" />
		<div class="inline top" style="width:290px;border-left:1px solid #ccc;margin-left:25px;padding-left:15px">
			<h3 class="inline top font_shadow_gray" style="margin-top:-9px">ACME CMS</h3>
			...
			<div class="font_11" style="margin:20px 0 10px 0"><?php echo lang('ACME CMS, gerenciador de conteúdo simples para websites.')?></div>
			<div class="font_11" style="margin:20px 0 10px 0">
				...
				<div class="inline top bold" style="line-height:18px;margin:0px 0 0 0px">
					...
					<img src="<?php echo URL_IMG ?>/icon_bullet_external_link.gif" />
					<br />
