	...
	<div class="generic_box">
		...
		<div id="content">
			...
			<div style="width:250px;margin-left:30px;" class="inline top">
				...
				<form name="form_default" id="form_default" action="<?php echo URL_ROOT ?>/cms_access/forgot_password_process" method="post">
					...
					<div style="margin-top:35px">
						...
						<div style="margin:18px 0px 0 0" class="inline top">ou <a href="<?php echo URL_ROOT ?>/cms_access/login"><?php echo lang('voltar')?></a></div>
					</div>
				</form>
				<br />
			</div>
