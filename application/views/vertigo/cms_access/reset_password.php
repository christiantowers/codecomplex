		...
		<div id="content">
			...
			<div style="width:250px;margin-left:30px;" class="inline top">
				...
				<div style="margin-top:35px">
					<hr />
					<div style="margin:10px 3px 0 0" class="inline top"><button onclick="redirect('<?php echo URL_ROOT ?>/cms_access/login')"><?php echo lang('OK')?></button></div>
				</div>
				<?php } else { ?>
				...
				<form name="form_default" id="form_default" action="<?php echo URL_ROOT ?>/cms_access/reset_password_process" method="post">
					...
					<div style="margin-top:35px">
						...
						<div style="margin:18px 0px 0 0" class="inline top">ou <a href="<?php echo URL_ROOT ?>/cms_access/login"><?php echo lang('cancelar')?></a></div>
					</div>
				</form>
				<br />
				<?php } ?>
