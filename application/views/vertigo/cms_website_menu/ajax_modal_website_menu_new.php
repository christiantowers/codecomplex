...
<body>
	<div id="modal_content">
		...
		<!-- FORMULARIO -->
		<form id="form_default" name="form_default" action="<?php echo URL_ROOT ?>/cms_website_menu/ajax_modal_website_menu_new_process" method="post">
			<br />
			...
			<div id="form_line">
				...
				<div class="form_field" style="width:400px">
					<select name="id_website_menu_parent" id="id_website_menu_parent" style="width:312px">
			...
			<div id="form_line">
				...
				<div class="form_field" style="width:400px">
					<input type="text" name="rotule" id="rotule" value="" class="validate[required]" style="width:300px;" />
			...
			<div id="form_line">
				...
				<div class="form_field" style="width:400px">
					<input type="text" name="order" id="order" value="" alt="integer" style="width:50px;" />
