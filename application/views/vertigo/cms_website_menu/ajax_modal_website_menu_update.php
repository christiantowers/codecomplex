...
<body>
	<div id="modal_content">
		...
		<!-- FORMULARIO -->
		<form id="form_default" name="form_default" action="<?php echo URL_ROOT ?>/cms_website_menu/ajax_modal_website_menu_update_process" method="post">
			...
			<div id="form_line">
				...
				<div class="form_field" style="width:400px">
					<input type="text" name="rotule" id="rotule" value="<?php echo get_value($data, 'rotule') ?>" class="validate[required]" style="width:300px;" />
			...
			<div id="form_line">
				...
				<div class="form_field" style="width:400px">
					<input type="text" name="order" id="order" value="<?php echo get_value($data, 'order')?>" alt="integer" style="width:50px;" />
