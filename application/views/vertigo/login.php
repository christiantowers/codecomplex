	...
	<div class="generic_box">
		...
		<div id="content">
			...
			<div style="width:250px;margin-left:30px;" class="inline top">
				...
				<form action="<?php echo URL_ROOT ?>/cms_access/login_process" method="post">
					...
					<div style="margin-top:5px;"><a href="<?php echo URL_ROOT ?>/cms_access/forgot_password"><?php echo lang('Esqueceu sua senha?');?></a></div>
